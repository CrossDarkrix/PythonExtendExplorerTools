...
from PySide6.QtGui import (QFont, QStandardItem, QStandardItemModel, QDesktopServices, QCursor, QPixmap, QPixmapCache, QIcon, QImage, QGuiApplication, QColor)
...
class Credit(QWidget):
	def __init__(self, parent=None):
		...
		self.Fonts = QFont()
		self.Fonts.setPixelSize(23)
		self.setFont(self.Fonts)
		self.Credits = QLabel()
		self.Credits.setFont(self.Fonts)
		self.Credits.setText('\t\t\t\t: Licences :\n')
		self.Credits.setStyleSheet('QLabel{background: #2d2d2d;color: #ededed;}')
		self.py7zr = QLabel()
		...
		self.CreditLayout.addWidget(self.Credits, 0, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.py7zr, 1, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.py7zr_c, 2, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.Send2Trash, 3, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.Send2Trash_c, 4, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.PSUtil, 5, 0, Qt.AlignLeft)
		self.CreditLayout.addWidget(self.PSUtil_c, 6, 0, Qt.AlignLeft)
		for col in range(self.CreditLayout.columnCount()):
			self.CreditLayout.setColumnMinimumWidth(col, 2000)
...
class Ui_FullTools2(object):
	def setupUi(self, FullTools2):
		...
		self.Tab3.setStyleSheet('QWidget{background: #2d2d2d;color: #2d2d2d;} QTabBar::tab{background: #2d2d2d;color: White;border: 2px solid #1a1a1a;border-color: #1a1a1a;}')
		self.tab = QWidget()
...
"}")
		...
		self.Credits = Credit(self.tab_5)
		self.Credits.setGeometry(QRect(100, 10, 266, 588))
		self.Tab3.addTab(self.tab_5, "")
		...
		OutOfThread0.start()
		threading.Thread(target=self.UpdateCalendarCell, daemon=True).start()
	...
	def retranslateUi(self, Extend):
		...
		self.Tab3.setTabText(self.Tab3.indexOf(self.tab_5), QCoreApplication.translate("FullTools2", "クレジット及びライセンス", None))
