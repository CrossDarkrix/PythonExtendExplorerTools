	...
	def LoadMetadata(self):
		if len(self.FilePathList) == 1:
			...
			if platform.system() == 'Windows':
				...
				self.PreviewIcon.setPixmap(QFileIconProvider().icon(FolderFilePath).pixmap(QSize(57, 57)).scaled(57, 57, Qt.KeepAspectRatio, Qt.SmoothTransformation))
...
class SearchWindow(QObject):
	def __init__(self, parent=None, model=None):
		...
		self.ListView.setGeometry(QRect(0, 0, 800, 638))
...
"}")
		...
		self.UpdateCalendar = UpdateWidget(FullTools2)
		self.UpdateCalendar.TextSignal.connect(self.UpdateCalendarCell)
		self.loader = QPixmapCache()
		self.loader.clear()
...
def main():
	...
	translate.load('qt_{}'.format(QLocale().system().name()), '{}/Lang'.format(os.getcwd()))
